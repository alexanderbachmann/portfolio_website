...
// Import the logo
import biLogo from '../../assets/employer_logos/bi_logo.jpeg';
import rocheLogo from '../../assets/employer_logos/roche_logo.png';
import voodooLogo from '../../assets/employer_logos/voodoo_logo.png';
import googleLogo from '../../assets/employer_logos/google-logo.png';
import ecbLogo from '../../assets/employer_logos/ecb_logo.png';
import emmagLogo from '../../assets/employer_logos/emma_logo.png';
  ...
  const experiences = [
    {
      ...
      logo: biLogo, // Using the imported logo
      description: [
        "Drive the vision, strategy, and roadmap for data products enabling Omnichannel and Customer Journey insights.",
        "Translate business needs into scalable data solutions and oversee end-to-end delivery from design to user adoption.",
        "Align cross-functional teams, manage risks, and ensure data products are usable, sustainable, and business-aligned"
      ]
    },
    {
      company: "Roche",
      role: "Global BI Analyst",
      period: "2023 - 2025",
      location: "Barcelona, Spain",
      logo: rocheLogo,
      description: [
    ...
    },
    {
      ...
      description: [
        ...
        "Wrote complex SQL queries integrating multiple data sources, enabling detailed analysis and actionable insights for business\n" +
        "partners."
      ]
    },
    {
